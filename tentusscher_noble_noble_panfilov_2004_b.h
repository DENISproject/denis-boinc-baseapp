...
------------------------------------------------------------------------
 ...
 -- C File of the tentusscher_noble_noble_panfilov_2004_b model created for the DENIS Project -- 
...
namespace tentusscher_noble_noble_panfilov_2004_b{
	...
	void names(const char* &VoI, const char** constants, const char** rates, const char** states, const char** algebraic){
		...
		algebraic[47]  = "alpha_K1 in component inward_rectifier_potassium_current (per_millisecond)";
		algebraic[48]  = "beta_K1 in component inward_rectifier_potassium_current (per_millisecond)";
